...
package GLUT is
   ...
   -- Used to set options for features exclusive to the freeglut implementation
   -- replaced by "null" here
 ...
 --     pragma Import (StdCall, SetOption, "glutSetOption");
   ...
   procedure InitDisplayString (str  : Interfaces.C.Strings.chars_ptr);
   pragma Import (StdCall, InitDisplayString, "glutInitDisplayString");

   procedure InitDisplayString (str  : String);
   ...
   -- Feature exclusive to the freeglut implementation
   -- replaced by "null" here
 ...
 --     pragma Import (StdCall, LeaveMainLoop, "glutLeaveMainLoop");
   ...
   -- Feature exclusive to the freeglut implementation
   -- replaced by an implementation based on Ada.Containers.OrderedMaps
 ...
 --   pragma Import (StdCall, CloseFunc, "glutCloseFunc");
   ...
   function ExtensionSupported (str  : String) return Integer;
   ...
   procedure GameModeString (Str  : Interfaces.C.Strings.chars_ptr);
